package com.emba.embaapp.widget.tabview;
...
public class TabView extends LinearLayout implements View.OnClickListener{
    ...
    public void setViewPager(final ViewPager mViewPager) {
        ...
        if (this.mPagerAdapter == null) {
            throw new RuntimeException("You must set ViewPager's PagerAdapter before setting TabView's PagerAdapter");
        }
        ...
        if (mPagerAdapter instanceof OnItemIconTextSelectListener) {
            ...
            throw new RuntimeException("You must implement OnItemIconTextSelectListener");
        }
        initItem();
    }
